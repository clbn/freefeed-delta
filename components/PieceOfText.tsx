  ...
  return (
    <span className="piece-of-text" dir="auto">
      ...
      <style jsx global>{`
        ...
        .piece-of-text .shortened-link:after {
          content: ${`"\\2026"`};
        }
        .piece-of-text .shortened-link del {
        ...
        .piece-of-text .read-more {
          font-style: italic;
          white-space: nowrap;
        }
        .piece-of-text .p-break {
          display: block;
          height: 0.35em;
        }
        .piece-of-text .pilcrow {
          cursor: pointer;
        }      
        .piece-of-text .pilcrow:hover {
          padding: 1px;
          margin: -1px;
          border-radius: 2px;
